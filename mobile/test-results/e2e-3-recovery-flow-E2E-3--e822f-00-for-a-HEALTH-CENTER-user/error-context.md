...
- Name: e2e-3-recovery-flow.spec.ts >> E2E-3: Recovery Flow — Resolved User Re-Admitted >> E2E-3.3: POST /health/recovery/{id} endpoint returns 200 for a HEALTH_CENTER user
- Location: e2e/tests/e2e-3-recovery-flow.spec.ts:132:7

# Error details

```
Error: Recovery endpoint must return 200 or 409, got 500
